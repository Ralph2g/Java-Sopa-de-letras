...
public class Servidor{
    ...
    public void initList(){
        ...
        this.palabras.add(new Palabra("COMPUTADOR","Máquina electrónica que, mediante determinados programas, permite almacenar y tratar información, y resolver problemas de diversa índole.",0));
        this.palabras.add(new Palabra("PAIS","Territorio, con características geográficas y culturales propias, que puede constituir una entidad política dentro de un Estado",0));
